...
export const defaultAccounts: Account[] = [
  { id: uuidv4(), name: 'Наличные', type: AccountType.CASH, currency: Currency.RUB, balance: 15000, isShared: true, createdAt: new Date().toISOString() },
  { id: uuidv4(), name: 'Карта Сбербанк', type: AccountType.CARD, currency: Currency.RUB, balance: 85000, isShared: true, createdAt: new Date().toISOString() },
  { id: uuidv4(), name: 'Вклад', type: AccountType.SAVINGS, currency: Currency.RUB, balance: 200000, isShared: true, createdAt: new Date().toISOString() },
  { id: uuidv4(), name: 'Карта USD', type: AccountType.CARD, currency: Currency.USD, balance: 500, isShared: false, createdAt: new Date().toISOString() },
  { id: uuidv4(), name: 'Наличные EUR', type: AccountType.CASH, currency: Currency.EUR, balance: 200, isShared: false, createdAt: new Date().toISOString() },
];
...
export function generateSeedTransactions(accounts: Account[], categories: Category[]): Transaction[] {
  ...
  const transactions: Transaction[] = [
    {
      id: uuidv4(), type: TransactionType.INCOME, amount: 95000, currency: Currency.RUB,
